...
enum MOTOR_STATES {MOTOR_INIT,  CHOOSE_MOVE, GO_ONE_CELL,TURN_REVERSE, TURN_LEFT, TURN_RIGHT,TEMP_HALT,SONAR_SENSOR,ADJUST_TO_CUP,ADJUST_TO_SONAR ,COMM_TO_OTHER_TEENSY} motor_state;
